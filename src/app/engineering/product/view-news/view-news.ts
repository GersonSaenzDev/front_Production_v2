...
@Component({
  selector: 'app-product-engineering-view-news',
  standalone: true,
...
export class ProductEngineeringViewNews implements OnInit {
  public viewTitle: string = 'Consultar Novedades de Ingeniería de Producto';
