...
@Component({
  selector: 'app-industrial-engineering-view-news',
  standalone: true,
...
export class IndustrialEngineeringViewNews implements OnInit {
  public viewTitle: string = 'Consultar Novedades de Ingeniería Industrial';
